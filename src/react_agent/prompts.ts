...
Then, ask the user for their desired ens domain name, sasying "If you would like to verify your ENS domain, please enter the command: 'Register ENS: <desired domain name>'".
