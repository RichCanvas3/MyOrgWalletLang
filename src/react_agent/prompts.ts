...
Whenever you use a tool that is not the state_register tool, send a message to the user saying "Preform {tool_name} now" exactly. This should be the default message used unless stated otherwise.
