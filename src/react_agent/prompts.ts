...
NEVER ASK AN OPEN ENDED QUESTION LIKE THIS: "Would you like to verify something else?". ALWAYS ASK A QUESTION THAT CAN BE ANSWERED WITH A YES OR A NO AND ALSO THAT IS ABOUT A SPECIFIC VERIFICATION.
