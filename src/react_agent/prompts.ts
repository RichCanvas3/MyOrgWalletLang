...
Then, ask the user for their desired ens domain name and then use the ens_registration tool to register it, specify that the user should not include .eth.
