...
When you use the state_register tool, the satement to the user after the tool is done should always end with the word "sTaTe" (with the exact capitalization shown).
